...
/**
 * <p>Java class for itemResult.Type complex type.
 * 
 ...
 *       &lt;group ref="{http://www.imsglobal.org/xsd/imsqti_v2p1}itemResult.ContentGroup"/&gt;
 *       &lt;attGroup ref="{http://www.imsglobal.org/xsd/imsqti_v2p1}itemResult.AttrGroup"/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class ItemResult {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "templateVariable", namespace = "http://www.imsglobal.org/xsd/imsqti_v2p1", type = TemplateVariable.class, required = false),
        @XmlElementRef(name = "responseVariable", namespace = "http://www.imsglobal.org/xsd/imsqti_v2p1", type = ResponseVariable.class, required = false),
        @XmlElementRef(name = "outcomeVariable", namespace = "http://www.imsglobal.org/xsd/imsqti_v2p1", type = OutcomeVariable.class, required = false)
    })
    @XmlMixed
