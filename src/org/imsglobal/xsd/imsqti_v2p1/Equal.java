 ...
 *       &lt;group ref="{http://www.imsglobal.org/xsd/imsqti_v2p1}equal.ContentGroup"/&gt;
 *       &lt;attGroup ref="{http://www.imsglobal.org/xsd/imsqti_v2p1}equal.AttrGroup"/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class Equal {
    ...
    @XmlAttribute(name = "toleranceMode", required = true)
    protected ToleranceModeType toleranceMode;
    @XmlAttribute(name = "tolerance")
    protected List<String> tolerances;
    @XmlAttribute(name = "includeLowerBound")
    protected Boolean includeLowerBound;
    @XmlAttribute(name = "includeUpperBound")
     ...
     * 
     */
    public List<String> getTolerances() {
        if (tolerances == null) {
            tolerances = new ArrayList<String>();
        }
