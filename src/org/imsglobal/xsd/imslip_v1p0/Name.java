 ...
 *         &lt;element ref="{http://www.imsglobal.org/xsd/imslip_v1p0}partname" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Name {
    ...
    protected List<Partname> partnames;
    ...
    /**
     * Gets the value of the partnames property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the partnames property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPartnames().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Partname> getPartnames() {
        if (partnames == null) {
            partnames = new ArrayList<Partname>();
        }
