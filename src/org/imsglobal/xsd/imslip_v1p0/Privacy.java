 ...
 *         &lt;element ref="{http://www.imsglobal.org/xsd/imslip_v1p0}privacyfield" maxOccurs="unbounded"/&gt;
...
public class Privacy {
    ...
    @XmlElement(name = "privacyfield", required = true)
    protected List<Privacyfield> privacyfields;
    ...
    /**
     * Gets the value of the privacyfields property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the privacyfields property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPrivacyfields().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<Privacyfield> getPrivacyfields() {
        if (privacyfields == null) {
            privacyfields = new ArrayList<Privacyfield>();
        }
